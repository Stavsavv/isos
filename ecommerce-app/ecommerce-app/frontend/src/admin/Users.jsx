...
import { deleteUserProfile, updateUserRole } from "../services/adminApi.js";
  ...
  useEffect(() => {
    async function fetchUsers() {
      try {
        ...
        setError('Failed to load users. Check Firestore rules and indexes.');
                ...
                {users.length === 0 ? (
                  ...
                  users.map((u) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <span
                          className={`badge ${u.role === "admin" ? "bg-primary-100 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400" : "bg-surface-100 text-surface-600 dark:bg-surface-800 dark:text-surface-400"}`}
                        >
                          {u.role === "admin" ? (
